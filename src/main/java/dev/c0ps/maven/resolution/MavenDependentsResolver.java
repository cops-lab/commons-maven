...
public class MavenDependentsResolver {
    ...
    private void resolve(Pom pom, ResolverConfig config, Set<ResolvedRevision> dependents, Set<Object> visited, boolean stopAfterThis, Scope propagatedScope, int depth) {
