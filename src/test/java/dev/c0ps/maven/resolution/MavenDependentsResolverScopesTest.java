...
import static dev.c0ps.maven.data.Scope.RUNTIME;
import static dev.c0ps.maven.data.Scope.SYSTEM;
...
public class MavenDependentsResolverScopesTest extends AbstractMavenDependentsResolverTest {
    ...
    private void add(String from, Dep... tos) {
        ...
        for (var to : tos) {
            ...
            var d = new Dependency(partsTo[0], partsTo[0], parseVersionSpec(partsTo[1]), Set.of(), to.scope, false, "jar", "");
