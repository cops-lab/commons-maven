...
import static dev.c0ps.maven.data.Scope.IMPORT;
...
public class RestMavenResolverTest {
    ...
    private static final Revision DEFAULT_REVISION = new ResolvedRevision(0, "g", "a", "2.3.4", new Timestamp(1234567890000L), IMPORT);
    ...
    public void setup() {
        httpd.reset();
        httpd.setResponse("application/json", "[{\"groupId\":\"g\",\"artifactId\":\"a\",\"version\":\"2.3.4\",\"createdAt\":1234567890000,\"scope\":\"IMPORT\"}]");

        sut = new RestMavenResolver("http://127.0.0.1:" + PORT + "/", objectMapper());
    }

    private static ObjectMapper objectMapper() {
        return new ObjectMapper().registerModule(new CommonsMavenDataModule());
    }
