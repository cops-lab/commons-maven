...
public class Pom {
    ...
    private final transient GAV gav;
    private final transient GA ga;

    // use LinkedHashSet for dependencies, because order is relevant for resolution
    public Pom(String groupId, String artifactId, String packagingType, String version, String parentCoordinate, long releaseDate, String projectName, LinkedHashSet<Dependency> dependencies,
            Set<Dependency> dependencyManagement, String repoUrl, String commitTag, String sourcesUrl, String artifactRepository) {
    ...
    public String toCoordinate() {
        return new StringBuilder().append(groupId).append(':').append(artifactId).append(':').append(packagingType).append(':').append(version).toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        return hashCode == ((Pom) obj).hashCode;
    }
